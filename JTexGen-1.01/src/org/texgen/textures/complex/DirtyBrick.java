...
public class DirtyBrick extends AbstractTexture {
    ...
    public DirtyBrick() {                        
        Texture mortar = new Dirty(new SolidTexture(new RGBAColor(200,200,200)),RGBAColor.black(),44,4,0.35); 
        Texture brickColor = new Dirty(new SolidTexture(new RGBAColor(128,32,16)),RGBAColor.black(),46,3,0.4); 
        Texture temp = new BrickTexture(brickColor,mortar);
        brick = new Dirty( temp,RGBAColor.black(),18,5,0.35);                        
    }
