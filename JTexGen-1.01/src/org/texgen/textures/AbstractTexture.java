...
public abstract class AbstractTexture implements Texture {
     ...
     */
    protected double calculateValueFromSignal(double u, double v, ChannelSignal signal) {
        return calculateValueFromSignal(u, v, signal, 0);
    }
     ...
     * @return the value for this signal at point u,v
     */
    protected double calculateValueFromSignal(double u, double v, ChannelSignal signal, double defaultValue) {
        if (signal == null) {
            return defaultValue;
        }
