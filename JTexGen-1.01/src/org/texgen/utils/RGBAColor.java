...
public class RGBAColor {
	...
	public void merge(RGBAColor color, double level) {
		red = ((int) Gradient.interpolate1(red, color.red, level));
		green = ((int) Gradient.interpolate1(green, color.green, level));
		blue = ((int) Gradient.interpolate1(blue, color.blue, level));
		alpha = Gradient.interpolate1(alpha, color.alpha, level);
	}
