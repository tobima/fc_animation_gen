...
public class Background extends AbstractTexture {
    ...
    /**
     * Constructs a Background with a texture and a background texture
     * @param texture
     * Texture to mix over the background
     * @param backgroundTexture
     * Texture used to color the background
     */    
    public Background(Texture texture, Texture backgroundTexture) {
        mixer = new MergedTexture(backgroundTexture, texture);
    }
