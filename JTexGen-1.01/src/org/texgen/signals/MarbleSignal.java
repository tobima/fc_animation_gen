 ...
 * The builder can be invoked using the following code : <br/> <br/><code>
 * 
 * 
 * MarbleSignal signal = new MarbleSignal.Builder()<br/>&nbsp.setOctaves(10)&nbsp.setUOffset(10)<br/>
 * 		&nbsp.setSineScale(10)<br/>&nbsp.setSpeed(1.5)<br/>&nbsp.build();
 * </code>
 * 
 * @author Andy Gibson
 */
public class MarbleSignal extends AbstractChannelSignal {
	 ...
	 */
	public MarbleSignal(double uOffset, double vOffset, double sineScale,
			double speed, int octaves, double size) {
	...
	public double getValue(double u, double v) {
		return getNoise().noisySine(u + uOffset, v + vOffset, sineScale, speed,
				octaves)
				* size;
	}
	...
	public static class Builder {
		...
		public MarbleSignal build() {
			return new MarbleSignal(uOffset, vOffset, sineScale, speed,
					octaves, size);
		}
